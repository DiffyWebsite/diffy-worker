        ...
        page.on('response', async (response) => {
          ...
          if (url.endsWith('.css') && response.ok()) {
            ...
            try {
              ...
              logger.warn(jobItem.id + ':' + jobItem.breakpoint + ':' + jobItem.url, 'Error caching CSS response', error);
            }
            ...
            try {
              ...
              logger.warn(jobItem.id + ':' + jobItem.breakpoint + ':' + jobItem.url, 'Error caching font response', error);
            }
          }
        });
      }
