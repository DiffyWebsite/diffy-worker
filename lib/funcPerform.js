        ...
        if (jobItem.project_id === 21292 && parseInt(jobItem.breakpoint) === 1440 && !page.isClosed()) {
          ...
          if (hasScrollHash) {
            await page.evaluate(() => {
              ...
              Object.defineProperty(window, 'scrollY', { get: () => scrollValue, configurable: true })
              Object.defineProperty(window, 'pageYOffset', { get: () => scrollValue, configurable: true })
              Object.defineProperty(document.documentElement, 'scrollTop', { get: () => scrollValue, configurable: true })
              Object.defineProperty(document.body, 'scrollTop', { get: () => scrollValue, configurable: true })
              window.dispatchEvent(new Event('scroll', { bubbles: true }))
              document.dispatchEvent(new Event('scroll', { bubbles: true }))
            })
            await page.waitForTimeout(500)
