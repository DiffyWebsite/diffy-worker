...
class ChromiumBrowser {
  args = ['--no-sandbox', '--disable-setuid-sandbox', '--disable-web-security', '--dns-prefetch-disable', '--ignore-certificate-errors', '--host-resolver-rules=MAP * 8.8.8.8,EXCLUDE localhost']
  browser = null
  debug = false
  local = false
