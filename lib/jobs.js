...
class Jobs {
  ...
  _getAdvancedArgs (project) {
    ...
    if (
      (Object.hasOwn(advanced, 'psStretchedImagesStabilization') && advanced.psStretchedImagesStabilization) ||
      (Object.hasOwn(advanced, 'stretched_images_stabilization') && advanced.stretched_images_stabilization)
    ) {
