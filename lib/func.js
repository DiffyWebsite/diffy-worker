    ...
    try {
      return await page.evaluate(() => {
        ...
        for (const img of document.querySelectorAll('img')) {
          ...
          // Skip unless rendered height grew significantly beyond the natural height
          if (rect.height <= img.naturalHeight * 2) continue
        ...
        for (const el of document.querySelectorAll('div,section,article,header,footer,main,aside,nav')) {
          ...
          if (heightToWidthRatio > BLOCK_HEIGHT_RATIO) {
            results.blocks.push({
