...
module.exports = {
  ...
  addFixtures: async (page, job) => {
        ...
        return new Promise((resolve, reject) => {
          try {
            ...
            if (src && w && h) {
              ...
              console.log('Can\'t add diffy image fixture', selector, src, h, w) // Debug
              return resolve()
            }
          } catch (e) {
            console.error('Failed to diffy image fixture', e) // TODO: Prettify error dump
    ...
    logger.log('Diffy fixtures were added.')
  ...
  auth: async (page, job) => {
    ...
    if (checkArgs(job, 'before_login_css')) {
      logger.log("Clicking before login element.");
    ...
    try {
      ...
      logger.log("Navigation after login successful.");
    } catch (error) {
